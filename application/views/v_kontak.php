...
<html class="no-js">
			...
			<div class="header-inner">
				...
				<nav role="navigation">
					<ul>
						...
						<li><a href="<?php echo base_url().'index.php/ourteam'?>">Our Team</a></li>
						<li class="active"><a href="<?php echo base_url().'index.php/kontak'?>">Contact</a></li>
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'theme/images/cakakk.png'?>);">
			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i> Jalan Terusan Ryacudu, Desa Way Hui, Kecamatan Jati Agung, Lampung Selatan 35365</li>
						<li><i class="icon-phone"></i>(0721) 8030188, (0721) 8030189</li>
						<li><i class="icon-envelope"></i><a href="#">info@cakak.com</a></li>
						<li><i class="icon-globe"></i><a href="#">www.cakak.com</a></li>
					</ul>
				</div>

				<div class="col-md-8 col-md-push-1 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
					<div class="row">
					<form method="post" action="<?php echo base_url().'kontak'?>">
						<div class="col-md-6">
